...
3. **Ejecución de Suite y Reporte de Fallos (Bucle de Auto-Curación)**:
   ...
   - Si alguna prueba falla o se encuentran discrepancias severas de código, **genera un archivo de logs de fallo detallado** en la carpeta del cambio y reporta de manera estructurada los fallos de test a DaniBot para que reactive al `@sdd-implementer` en el bucle de auto-curación.
...
5. **Cierre de Calidad**:
   - Cuando las pruebas estáticas, la suite de tests, y el reporte curl real estén listos e impecables, notifica a DaniBot que la Fase 4 ha concluido de forma sumamente exitosa.
