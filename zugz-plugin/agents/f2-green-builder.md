...
- Tu contract: [prompts/contracts/f2-green-builder-contract.md](file://./prompts/contracts/f2-green-builder-contract.md)
- Tu boundary: [prompts/boundaries/f2-green-builder-boundary.md](file://./prompts/boundaries/f2-green-builder-boundary.md)
...
2. **Si la tarea es UI, `active_design_system` es `null` Y
   ...
   - **RECHAZÁ** la implementación. Retorná:
     ```
     [f2-green-builder] ⛔ Gate de design system fallido.
...
```
[f2-green-builder] Implementación mínima completa.
Stack: <stack_profile>
...
> Detalle completo en `prompts/boundaries/f2-green-builder-boundary.md`.
