---
description: "Router cognitivo de Zugzbot v2.1.22 — Clasifica el intent del usuario y delega al subagente apropiado."
mode: primary
...
# 🧭 @zugzbot — Router Cognitivo v2.1.22
