...
Sincronizado manualmente con `design/DESIGN-*.md` (la lista no se regenera por
...
`<INSTALL_DIR>/design/` durante la instalación (`npx zugzbot`). En modo
...
|---|------|--------|------|---------|------|
| 1 | airbnb | Airbnb | `design/DESIGN-airbnb.md` | `#ff385c` | Marketplace cálido, pill-shaped, fotos primero |
| 2 | apple | Apple | `design/DESIGN-apple.md` | `#0066cc` | Minimal premium, monochrome, system font, edge-to-edge |
| 3 | meta | Meta | `design/DESIGN-meta.md` | `#0064e0` | Utility-first, blue brand, hairline borders, dual-CTA |
| 4 | nike | Nike | `design/DESIGN-nike.md` | `#111111` | Bold sports, black/white, Futura uppercase, editorial |
| 5 | notion | Notion | `design/DESIGN-notion.md` | `#0075de` | Editorial productivity, off-white canvas, Inter, stickers |
| 6 | renault | Renault | `design/DESIGN-renault.md` | Sunlight Yellow | Automotive, dark, NouvelR display, diamond mark |
| 7 | theverge | The Verge | `design/DESIGN-theverge.md` | `#3cffd0` (jelly mint) | Editorial tech media, dark, oversized Manuka, timeline |
| 8 | uber | Uber | `design/DESIGN-uber.md` | `#000000` | Clean utilitarian, black/white, geometric sans, full-pill |
| 9 | voltagent | Voltagent | `design/DESIGN-voltagent.md` | `#00d992` | Devtool, near-black canvas, mono accents, code-mock hero |
| 10 | x.ai | xAI | `design/DESIGN-x.ai.md` | `#ffffff` | AI brand, near-black canvas, geometric sans, cosmic |
