...
**Category**: react
**URL**: https://www.heroui.com/en/docs/react/getting-started/mcp-server
> Access HeroUI v3 documentation directly in your AI assistant


> **Nota para usuarios de `zugzbot-sdd` v2.1.8+**: este MCP ya viene **preconfigurado** en el `opencode.json` que genera el plugin, con `enabled: true` y scope a los 5 agentes UI (`sdd-planner`, `sdd-builder`, `f2-refactor-improver`, `sdd-tester`, `aux-refactor`). No necesitás seguir esta guía a menos que uses otro editor o quieras deshabilitarlo.
>
> Ver [`SKILL.md` sección 7](../SKILL.md#7-ai-agent-setup-recomendado) para instrucciones de opt-out.
