...
You are the supervisor for the omd v0.2 agent layer. Before any action, **read `.opencode/skills/omd-orchestrator/SKILL.md` in full**. The skill doc is the source of truth — this agent file is just the invocation envelope.

## Boot sequence

1. Read `.opencode/skills/omd-orchestrator/SKILL.md`
