...
### Styling & Tailwind → [styling.md](../../docs/shadcn/rules/styling.md)
...
### Forms & Inputs → [forms.md](../../docs/shadcn/rules/forms.md)
...
### Use Components, Not Custom Markup → [composition.md](../../docs/shadcn/rules/composition.md)
...
### Icons → [icons.md](../../docs/shadcn/rules/icons.md)
...
- [rules/forms.md](../../docs/shadcn/rules/forms.md) — FieldGroup, Field, InputGroup, ToggleGroup, FieldSet, validation states
- [rules/composition.md](../../docs/shadcn/rules/composition.md) — Groups, overlays, Card, Tabs, Avatar, Alert, Empty, Toast, Separator, Skeleton, Badge, Button loading
- [rules/icons.md](../../docs/shadcn/rules/icons.md) — data-icon, icon sizing, passing icons as objects
- [rules/styling.md](../../docs/shadcn/rules/styling.md) — Semantic colors, variants, className, spacing, size, truncate, dark mode, cn(), z-index
- [rules/base-vs-radix.md](../../docs/shadcn/rules/base-vs-radix.md) — asChild vs render, Select, ToggleGroup, Slider, Accordion
- [cli.md](../../docs/shadcn/cli.md) — Commands, flags, presets, templates
- [registry.md](../../docs/shadcn/registry.md) — Authoring source registries, `include`, item definitions, dependencies, GitHub registry rules
- [customization.md](../../docs/shadcn/customization.md) — Theming, CSS variables, extending components
